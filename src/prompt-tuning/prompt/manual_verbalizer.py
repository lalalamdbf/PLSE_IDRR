...
class ManualVerbalizer(Verbalizer):
    ...
    def project(self,
        ...
        label_words_logits -= 1e9*(1-self.label_words_mask)
        
        return label_words_logits

    def process_logits(self, logits: torch.Tensor, conn_linear_logits = None, **kwargs):
    ...
    def aggregate(self, label_words_logits: torch.Tensor) -> torch.Tensor:
        ...
        label_words_logits = (label_words_logits).max(axis=-1)[0]
        return label_words_logits
